...
|---|---|---|---|---|---|---|
| [YOUNG IN Chromass Track C](youngin-chromass-format-investigation.md) | YOUNG IN Chromass and DataApex official material plus owner-supplied local intake | Exact-profile FID/TCD scientific signals for 9.0.1.19 and 9.1.0.76 | 28 local-only structural PRMs plus ten 9.0 and five 9.1 same-run full-curve pairs | Yes, local-only completed files | 28 files / 353,830 B smallest | Shared time/numeric-response semantics validated over 401,520 points; physical units remain profile-specific; direct PRM peaks remain unsupported |
...
23 YL-Clarity 9.0.1.19 structural PRMs and five 9.1.0.76 PRMs. Ten independent 9.0
FID+TCD full-curve pairs validate 263,520 points; five 9.1 pairs validate 138,000. The
